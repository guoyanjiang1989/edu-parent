...
<head>
    ...
    <link rel="Stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/bridging.css"/>
...
<form id="form1" >
            ...
            <header>
                ...
                <div class="header_tab">
                    <ul>
                        ...
                        <li><span class="header_hi">Hi,</span>
                            <span class="header_usename">郭永峰</span>！</li>
                ...
                <ul id="showMainNav" class="fix">
                    <li class="navContent nav_current">
                        <a href="#" class="showNav" id="user" data-name="main_iframe"
                           ...
                           data-url="${pageContext.request.contextPath}/manage.do">用户管理</a>
                    </li>
                    <li class="navContent">
    ...
    <div id="main_iframe"
        ...
        <iframe class="main_iframe" id="home_iframe" frameborder="0"
                border="0" src="${pageContext.request.contextPath}/manage.do"></iframe>
    </div>
