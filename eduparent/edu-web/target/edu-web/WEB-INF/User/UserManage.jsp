...
<body>
    ...
    <div class="main">
                    ...
                    <ul id="show_iframe" class="switch_nav">
						<li class="nav_current">
							<a href="#" class="subNavigation" id="A001010"
							   ...
							   data-url="${pageContext.request.contextPath}/info.do">用户信息</a>
						</li>
						<li class="nav_current">
		...
		<div id="common_iframe" class="maincontent">
			<iframe class="common_iframe" id="A001010_iframe" frameborder="0" border="0" src="${pageContext.request.contextPath}/info.do"></iframe>
		</div>
    </div>
    </form>
</body>
